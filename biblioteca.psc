...
Funcion registrarDevolucion(libros Por Referencia, socios Por Referencia, prestamos Por Referencia, cantLibros, cantSocios)
    Definir i, j, indiceLibro, indiceSocio, indicePrestamo, diasAtraso, diasPenalidad Como Entero
		...
		SiNo
			...
			Si op = "S" Entonces
				...
				Sino
					...
					libros[indiceLibro,5] <- ConvertirATexto(ConvertirANumero(libros[indiceLibro,5]) + 1)
